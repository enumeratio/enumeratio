...
// so the kernel carries more digits than asked for and rounds back. Pinned against mpmath as
// role:test examples on HurwitzZeta's own record (originally collected against
// scripts/collect-precise-zeta-goldens.ts's output).
