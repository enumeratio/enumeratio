...
-- (dyck_paths.to_noncrossing_partition -> non_crossing_partitions moved to
-- packs/trees-graphs/cross-collection-maps.trees-graphs.sql — the codomain is a pack-owned collection and
-- examples.catalog_metadata's codomain-resolution self-test would fail loading core alone, #283 phase 3)
