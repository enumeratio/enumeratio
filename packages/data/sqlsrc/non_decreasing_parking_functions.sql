-- requires: parking_functions, realizer
...
-- outright (same objects, simpler expression under the new model).
...
INSERT INTO base_example (suite, title, kind, expected, description, sql) VALUES
  ('non_decreasing_parking_functions','|NDPF(4)| = 14 (Catalan(4))','eq','14','base_restrict counts the filtered floor',$q$
