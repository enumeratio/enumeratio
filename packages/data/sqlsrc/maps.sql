...
INSERT INTO base_example (suite, title, kind, expected, description, sql) VALUES
  ...
  ('maps','permutations maps include at least the RSK pair rsk_insertion + rsk_recording (a floor — more may be added)','eq','true','base_map rows',$q$
    SELECT (array_agg(map_id) @> ARRAY['binary_search_tree','complement','cycle_partition','cycle_type','cyclic_shift','descent_composition','descent_set','inverse','permutahedron_vertex','reverse','rsk','rsk_insertion','rsk_recording','to_lehmer_code'])::text
