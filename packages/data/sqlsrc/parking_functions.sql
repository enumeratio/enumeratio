...
-- satisfying the parking condition, emit in lex order of the spots array) + a contains engine; NO fiber_count
-- accel is provided (the closed form is awkward at n=0), so cardinality just counts the floor.
...
INSERT INTO base_example (suite, title, kind, expected, description, sql) VALUES
  ('parking_functions','cardinality anchor = (n+1)^(n-1) for n=1..5 (floor count, no accel)','eq','1,3,16,125,1296','2^1,3^1,4^2,5^3,6^4',$q$
