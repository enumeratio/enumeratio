-- requires: distinct_partitions, odd_partitions, non_crossing_partitions, non_nesting_partitions, maps, permutations, standard_tableaux
...
--
-- Euler's theorem: #{partitions of n into DISTINCT parts} = #{partitions of n into ODD parts} (both A000009). The
-- witnessing bijection is Glaisher's:
