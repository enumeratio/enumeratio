...
export type System = "wolfram" | "sympy" | "mpmath" | "sage" | "oscar" | "julia" | "mathlib4" | "rust";
...
export const SYSTEMS: readonly SystemSpec[] = [
  ...
  },
  {
    ...
    label: "mpmath",
    wired: true,
    strength: "arbitrary-precision numerics, and correct on branches Wolfram's N[] is not — ζ(−n, a) among them",
  },
  {
    name: "sage",
    label: "SageMath",
    wired: true,
    strength: "exact number theory and combinatorics; bundles SymPy and mpmath but has much more besides",
  },
  {
    name: "oscar",
    label: "Oscar (Julia)",
  ...
  },
  {
    ...
    wired: true,
    strength: "FLINT number theory and the classic combinatorial counts, light enough to install in CI",
  },
  {
    name: "mathlib4",
    label: "Lean 4 / Mathlib",
    wired: true,
    strength: "definitions rather than values: the place to check that a convention is the standard one",
  },
  {
    name: "rust",
    label: "Rust (num, primal, statrs, adic)",
    wired: true,
    strength: "the numeric and number-theory crates a Rust user would reach for, and the adic crate for p-adic numbers",
  },
];
