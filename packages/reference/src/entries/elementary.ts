...
export const elementary: readonly ReferenceEntry[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      {
        id: "cos-pi-over-3",
        expr: ["Cos", ["Divide", "Pi", 3]],
        expected: ["Rational", 1, 2],
      },
      {
        id: "cos-pi-over-2",
        expr: ["Cos", ["Divide", "Pi", 2]],
        expected: 0,
      },
      {
        id: "cos-pi",
  ...
  },
  {
    ...
    examples: [
      ...
      {
        id: "tan-pi-over-4",
        expr: ["Tan", ["Divide", "Pi", 4]],
        expected: 1,
      },
      {
        id: "tan-pi-over-3",
        expr: ["Tan", ["Divide", "Pi", 3]],
        expected: ["Sqrt", 3],
      },
      {
  ...
  },
  {
    ...
    examples: [
      {
        id: "cot-pi-over-6",
        expr: ["Cot", ["Divide", "Pi", 6]],
        expected: ["Sqrt", 3],
      },
      {
        id: "cot-pi-over-4",
        expr: ["Cot", ["Divide", "Pi", 4]],
        expected: 1,
      },
      {
        id: "cot-pi-over-3",
  ...
  },
  {
    ...
    examples: [
      ...
      {
        id: "sec-pi-over-4",
        expr: ["Sec", ["Divide", "Pi", 4]],
        expected: ["Sqrt", 2],
      },
      {
        id: "sec-pi-over-3",
        expr: ["Sec", ["Divide", "Pi", 3]],
        expected: 2,
      },
      {
        id: "sec-pi",
  ...
  },
  {
    ...
    examples: [
      {
        id: "csc-pi-over-6",
        expr: ["Csc", ["Divide", "Pi", 6]],
        expected: 2,
      },
      {
        id: "csc-pi-over-4",
        expr: ["Csc", ["Divide", "Pi", 4]],
        expected: ["Sqrt", 2],
      },
      {
        id: "csc-pi-over-2",
        expr: ["Csc", ["Divide", "Pi", 2]],
        expected: 1,
      },
      {
  ...
  },
  {
    ...
    examples: [
      ...
      },
      {
        id: "n-sinh-1",
        expr: ["N", ["Sinh", 1]],
        expected: { num: "1.17520119364380145688" },
      },
      {
  ...
  },
  {
    ...
    examples: [
      ...
      },
      {
        id: "n-cosh-1",
        expr: ["N", ["Cosh", 1]],
        expected: { num: "1.54308063481524377848" },
      },
      {
  ...
  },
  {
    ...
    examples: [
      ...
      },
      {
        id: "n-tanh-1",
        expr: ["N", ["Tanh", 1]],
        expected: { num: "0.761594155955764888119" },
      },
      {
  ...
  },
  {
    ...
    examples: [
      {
        id: "default-base-is-10",
        expr: ["Log", 100],
        expected: 2,
        caption: "Default base is 10",
      },
      {
