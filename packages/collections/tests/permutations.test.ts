...
// Golden JSON of the first few elements per family — committed data compared with
// toEqual, never toMatchSnapshot (its client isn't wired up under `vp run`, see
// no-snapshots.test.ts). Regenerate with `UPDATE_PERMUTATIONS_GOLDEN=1 vp test`.
