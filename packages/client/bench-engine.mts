...
const POINTS: Record<string, [string, string]> = {
  ...
  multicomplex_add:                    [`multicomplex_add(${m([1, 2], 7)}, ${m([3, 4], 7)})`, `multicomplex_add(${m([1, 2, 3, 4, 5, 6, 7, 8], 97)}, ${m([8, 7, 6, 5, 4, 3, 2, 1], 97)})`],
  multicomplex_conj:                   [`multicomplex_conj(${m([1, 2], 7)})`,               `multicomplex_conj(${m([1, 2, 3, 4, 5, 6, 7, 8], 97)})`],
  multicomplex_mul:                    [`multicomplex_mul(${m([1, 2], 7)}, ${m([3, 4], 7)})`, `multicomplex_mul(${m([1, 2, 3, 4, 5, 6, 7, 8], 97)}, ${m([8, 7, 6, 5, 4, 3, 2, 1], 97)})`],
  multicomplex_neg:                    [`multicomplex_neg(${m([1, 2], 7)})`,                `multicomplex_neg(${m([1, 2, 3, 4, 5, 6, 7, 8], 97)})`],
  multicomplex_popcount:               ['multicomplex_popcount(5)',                'multicomplex_popcount(1048575)'],
