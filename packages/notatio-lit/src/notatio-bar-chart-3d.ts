...
import { barChart3dSvg } from "@enumeratio/notatio";
...
export class NotatioBarChart3D extends LitElement {
  ...
  protected override render(): unknown {
    return html`<span class="notatio-bar-chart-3d-box">${unsafeHTML(this._svg)}</span>`;
  }
}

if (!customElements.get("notatio-bar-chart-3d")) {
  customElements.define("notatio-bar-chart-3d", NotatioBarChart3D);
}
