...
export class NotatioGraphPlot extends LitElement {
  ...
  protected override render(): unknown {
    return html`<span class="notatio-graph-plot-box">${unsafeHTML(this.#markup())}</span>`;
  }
}

if (!customElements.get("notatio-graph-plot")) {
  customElements.define("notatio-graph-plot", NotatioGraphPlot);
}
