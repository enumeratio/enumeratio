...
/**
 * `<notatio-curve3d value="KnotCurve(TorusKnot(2, 3))">` -- a curve in space, from an
 ...
 * the same gestures `<notatio-plot3d>` uses.
 */
export class NotatioCurve3d extends LitElement {
  ...
  protected override render(): unknown {
    return html`<figure class="notatio-curve3d">
      <span
...
if (!customElements.get("notatio-curve3d")) {
  customElements.define("notatio-curve3d", NotatioCurve3d);
}
