...
import { formOfHead, splitHead } from "./heads.ts";
 ...
 * read-only `<notatio-output>` of the result. Renders in light DOM so the nested
    ...
    return html`
      <div class="notatio-cell">
        <div class="notatio-row">
          <span class="notatio-label notatio-in">In</span>
          ${this.#input()}
        </div>
        <div class="notatio-row">
