...
const CSS = `
notatio-input, notatio-output, notatio-cell { display: block; }
...
notatio-plot, notatio-plot3d { display: block; line-height: 0; }
notatio-plot .notatio-plot-box,
notatio-plot3d .notatio-plot-box { display: inline-block; max-width: 100%; }
notatio-plot svg { width: 340px; max-width: 100%; height: auto; overflow: hidden; }
notatio-plot3d svg { width: 360px; max-width: 100%; height: auto; overflow: visible; }
...
notatio-contourplot { display: block; line-height: 0; }
notatio-contourplot .notatio-contourplot-box { display: inline-block; max-width: 100%; }
notatio-contourplot svg { width: 340px; max-width: 100%; height: auto; overflow: hidden; }

/* Field & density visualisations (VectorPlot, StreamPlot, PolarPlot, DensityPlot). */
notatio-vectorplot { display: block; line-height: 0; }
notatio-vectorplot .notatio-vectorplot-box { display: inline-block; max-width: 100%; }
notatio-vectorplot svg { width: 340px; max-width: 100%; height: auto; overflow: hidden; }

notatio-densityplot { display: block; line-height: 0; }
notatio-densityplot .notatio-densityplot-box { display: inline-block; max-width: 100%; }
notatio-densityplot svg { width: 340px; max-width: 100%; height: auto; overflow: hidden; }

notatio-polarplot { display: block; line-height: 0; }
notatio-polarplot .notatio-polarplot-box { display: inline-block; max-width: 100%; }
notatio-polarplot svg { width: 260px; max-width: 100%; height: auto; overflow: hidden; }

/* 3-D list plots & bar charts share Plot3D's sizing -- a projected figure whose
   axis labels can sit just outside the viewBox. */
notatio-listplot3d { display: block; line-height: 0; }
notatio-listplot3d .notatio-listplot3d-box { display: inline-block; max-width: 100%; }
notatio-listplot3d svg { width: 360px; max-width: 100%; height: auto; overflow: visible; }

notatio-barchart3d { display: block; line-height: 0; }
notatio-barchart3d .notatio-barchart3d-box { display: inline-block; max-width: 100%; }
notatio-barchart3d svg { width: 360px; max-width: 100%; height: auto; overflow: visible; }
...
notatio-graphplot { display: block; line-height: 0; }
notatio-graphplot .notatio-graphplot-box { display: inline-block; max-width: 100%; }
notatio-graphplot svg { width: 340px; max-width: 100%; height: auto; overflow: visible; }

notatio-input math-field {
  width: 100%;
  font-size: 1.1rem;
...
.notatio-input-row { display: flex; align-items: stretch; position: relative; }
.notatio-input-row math-field {
  flex: 1;
  min-width: 0;
...
notatio-input math-field::part(virtual-keyboard-toggle),
notatio-input math-field::part(menu-toggle) { display: none; }
...
.nb-in notatio-input { flex: 1 1 auto; }
...
notatio-output[form="tree"] .notatio-render { display: block; flex: 1 1 0; min-width: 0; }
...
.notatio-curve3d .notatio-plot-box {
  display: block;
  cursor: grab;
  touch-action: none;
  user-select: none;
}
.notatio-curve3d .notatio-plot-box:active {
  cursor: grabbing;
}
.notatio-curve3d svg {
  width: 100%;
