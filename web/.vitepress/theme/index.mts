...
// @enumeratio/elements (the whole element + compute-engine tree) via Playground, and
...
export default {
  ...
  enhanceApp({ app }: EnhanceAppContext) {
    ...
    if (!import.meta.env.SSR) {
      ...
      // evaluation — see `loadEngine` in @enumeratio/elements. The imports resolve
