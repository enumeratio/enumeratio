    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Input", link: "/playground/input" },
          { text: "Output", link: "/playground/output" },
          { text: "Cell", link: "/playground/cell" },
          { text: "Figure (glyphs)", link: "/playground/figure" },
          { text: "Plot", link: "/playground/plot" },
          { text: "Plot 3D", link: "/playground/plot3d" },
          { text: "Contour Plot", link: "/playground/contourplot" },
          { text: "Density Plot", link: "/playground/densityplot" },
          { text: "Vector & Stream Plot", link: "/playground/vectorplot" },
          { text: "Polar Plot", link: "/playground/polarplot" },
          { text: "List Plot 3D", link: "/playground/listplot3d" },
          { text: "Bar Chart 3D", link: "/playground/barchart3d" },
          { text: "Chart", link: "/playground/chart" },
          { text: "GraphPlot", link: "/playground/graphplot" },
