...
`<notatio-density-plot>`. The expression is sampled on an `n`×`n` grid — the
same sampling `<notatio-contour-plot>` uses — and each sample is shaded on a
...
<Story
  title="A trig field">
<notatio-density-plot expr="Sin(x) * Cos(y)" xrange="-3.14,3.14" yrange="-3.14,3.14" />
</Story>
...
<notatio-density-plot expr="x^2 - y^2" xrange="-3,3" yrange="-3,3" legend label="x² − y²" />
</Story>
...
<notatio-density-plot expr="Sin(x * y)" xrange="-4,4" yrange="-4,4" n="80" legend />
</Story>
...
<notatio-density-plot expr="x^2 + y^2" xrange="-3,3" yrange="-3,3" zrange="0,30" legend x-label="x" y-label="y" />
</Story>
...
<notatio-density-plot data="[[0,1,2,3],[1,2,3,4],[2,3,4,5],[3,4,5,6]]" legend />
</Story>
