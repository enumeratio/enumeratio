...
`<notatio-output>` — read-only typeset rendering of a compute-engine expression.
...
<Story
  title="notatio input">
<notatio-output value="Sqrt(16) + 2^3" format="notatio" evaluate />
<notatio-output value="Binomial(n, k) + $\frac{1}{2}$" format="notatio" />
</Story>
...
<notatio-output value='["Sum",["Filter",["Range",1,["Subtract",["Length","p"],1]],["Function",["Greater",["At","p","i"],["At","p",["Add","i",1]]],"i"]]]' format="mathjson" form="tree" raw label="Def" />
</Story>
...
<notatio-output value='["List",["List",1,2],["List",3,4]]' format="mathjson" label="Out" />
</Story>
...
<notatio-output value='["Add",["Sin","x"],["Power","x",2]]' format="mathjson" form="python" label="Out" />
</Story>
...
<notatio-output value='["Add",2,2]' format="mathjson" evaluate expect="4" />
</Story>
