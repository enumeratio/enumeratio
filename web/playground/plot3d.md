...
A bivariate surface (`Plot3D`), rendered by `<notatio-plot3d>`. It samples an
...
<Story
  title="A saddle">
<notatio-plot3d value="x^2 - y^2" x-domain="-2,2" y-domain="-2,2" />
</Story>

<Story
  title="A ripple">
<notatio-plot3d value="Sin(x) * Cos(y)" x-domain="-3.14,3.14" y-domain="-3.14,3.14" />
</Story>
...
<notatio-plot3d value="Sin(x) * Cos(y)" x-domain="-3.14,3.14" y-domain="-3.14,3.14" spin />
</Story>
...
<notatio-plot3d value="Exp(-(x^2 + y^2) / 4)" x-domain="-4,4" y-domain="-4,4" label="Gaussian" color-legend />
</Story>
...
<notatio-plot3d value="Sin(x) * Cos(y)" x-domain="-3.14,3.14" y-domain="-3.14,3.14" azimuth="200" elevation="40" zoom="0.8" />
</Story>
...
<notatio-plot3d value="{Sin(x) * Cos(y) + 2.5, Cos(x) * Sin(y) - 2.5}" x-domain="-3.14,3.14" y-domain="-3.14,3.14" />
</Story>

<Story
  title="Axes off">
<notatio-plot3d value="x^2 - y^2" x-domain="-2,2" y-domain="-2,2" axes="false" />
</Story>
...
<notatio-plot3d value="Sin(_k * x) * Cos(_k * y)" x-domain="-3.14,3.14" y-domain="-3.14,3.14" params="{k, 0.5, 3}" />
</Story>
...
<notatio-plot3d value="(1 - _t) * (x^2 - y^2) + _t * Sin(x) * Cos(y) * 4" x-domain="-2,2" y-domain="-2,2" params="{t, 0, 1}" />
</Story>
...
<notatio-plot3d value="Sin(2 * Sqrt(x^2 + y^2) - _p)" x-domain="-4,4" y-domain="-4,4" params="{p, 0, 6.283}" />
</Story>
...
<notatio-plot3d value="Sin(x) * Cos(y)" x-domain="-3.14,3.14" y-domain="-3.14,3.14" gpu="100" />
</Story>
