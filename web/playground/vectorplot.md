...
Planar vector fields, rendered by `<notatio-vectorplot>`. The two components
...
<notatio-vectorplot u="-y" v="x" xrange="-2,2" yrange="-2,2" />
</Story>
...
<notatio-vectorplot field="x, -y" xrange="-2,2" yrange="-2,2" label="(x, −y)" />
</Story>
...
<notatio-vectorplot u="Sin(y)" v="Cos(x)" xrange="-3.14,3.14" yrange="-3.14,3.14" n="16" />
</Story>
...
<notatio-vectorplot type="stream" u="-y" v="x" xrange="-2,2" yrange="-2,2" />
</Story>
...
<notatio-vectorplot type="stream" u="x^2 - y^2" v="2 * x * y" xrange="-2,2" yrange="-2,2" n="11" steps="80" />
</Story>

<Story
  title="Shear flow">
<notatio-vectorplot type="stream" u="y" v="Sin(x)" xrange="-3.14,3.14" yrange="-2,2" n="10" x-label="x" y-label="y" />
</Story>
