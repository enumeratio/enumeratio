...
by `<notatio-contour-plot>`. The element samples an `n`×`n` grid of the
...
<notatio-contour-plot expr="x^2 - y^2" xrange="-3,3" yrange="-3,3" />
</Story>

<Story
  title="A trig field">
<notatio-contour-plot expr="Sin(x) + Cos(y)" xrange="-6.283,6.283" yrange="-6.283,6.283" />
</Story>
...
<notatio-contour-plot expr="x^2 + y^2" xrange="-3,3" yrange="-3,3" levels="[1,2,4,6,8]" />
</Story>
...
<notatio-contour-plot expr="Sin(x * y)" xrange="-3,3" yrange="-3,3" levels="12" n="60" label="sin(xy)" />
</Story>
...
<notatio-contour-plot expr="x^2 - y^2" xrange="-3,3" yrange="-3,3" filled />
</Story>

<Story
  title="Filled radial field with labels">
<notatio-contour-plot expr="x^2 + y^2" xrange="-3,3" yrange="-3,3" filled x-label="x" y-label="y" label="x² + y²" />
</Story>
...
<notatio-contour-plot data="[[0,1,2,3],[1,2,3,4],[2,3,4,5],[3,4,5,6]]" />
</Story>
...
- Surfaces live on their own page: [Plot 3D](/playground/plot-3d).
